...
from .models import TblDepartment, TblProgram, TblSubjInfo, TblRoomInfo, TblStudentPersonalData, TblStaffInfo, TblAddStaffInfo, TblStudentFamilyBackground, TblStudentAcademicBackground, TblStudentAcademicHistory, TblSchedule, TblUsers,TblStudentBasicInfoApplications
...
admin.site.register(TblStudentBasicInfoApplications)
